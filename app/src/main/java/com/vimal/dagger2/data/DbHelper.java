...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        tableCreateStatement(sqLiteDatabase);
    }

    private void tableCreateStatement(SQLiteDatabase sqLiteDatabase) {
        try{
    ...
    protected User getUser(Long userId) throws Resources.NotFoundException, NullPointerException{
        ...
        try{
            ...
            if(cursor.getCount() > 0){
                ...
                throw new Resources.NotFoundException("User Id with "+ userId + " was not found");
            }
